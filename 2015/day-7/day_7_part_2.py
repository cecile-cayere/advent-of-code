...
content = get_file_content('2015/day-7/input.txt')
content = split_string(content, "\n")

wires_off = {}
wires_on = {}

def init_wires(content):
    ...
    return wires_off, wires_on

def compute_wires(wires_off, wires_on):
...
wires_off, wires_on = init_wires(content)
new_b = compute_wires(wires_off, wires_on)

wires_off = {}
wires_on = {}
wires_off, wires_on = init_wires(content)
wires_on['b'] = new_b
print(convert_bits_to_int(compute_wires(wires_off, wires_on)))